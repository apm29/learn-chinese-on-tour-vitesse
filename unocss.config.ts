...
export default defineConfig({
  shortcuts: [
    ...
    ['btn-primary','cursor-pointer inline-block select-none transition-all hover:shadow-lg hover:bg-blue-600 text-white bg-blue-500 rounded-full px-4 py-2'],
    ['btn-send','cursor-pointer inline-block select-none transition-all hover:shadow-lg  hover:bg-blue-600 dark:hover:bg-blue-600 text-white bg-dark-300 dark:bg-purple-500 rounded px-4 py-2'],
